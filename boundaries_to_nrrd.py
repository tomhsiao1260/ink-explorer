...
# python boundaries_to_nrrd.py --x 2432 --y 2304 --z 10624 --w 768 --h 768 --d 768 --chunk 768

# Title

# python boundaries_to_nrrd.py --x 2860 --y 2853 --z 9657 --w 768 --h 1536 --d 768 --chunk 768
# python boundaries_to_nrrd.py --x 2973 --y 2769 --z 8889 --w 768 --h 1536 --d 768 --chunk 768
# python boundaries_to_nrrd.py --x 3140 --y 2700 --z 8121 --w 768 --h 1536 --d 768 --chunk 768
# python boundaries_to_nrrd.py --x 3264 --y 2666 --z 7353 --w 768 --h 1536 --d 768 --chunk 768
# python boundaries_to_nrrd.py --x 3360 --y 2666 --z 6585 --w 768 --h 1536 --d 768 --chunk 768
# python boundaries_to_nrrd.py --x 3360 --y 2373 --z 5817 --w 768 --h 1536 --d 768 --chunk 768

# python boundaries_to_nrrd.py --x 3380 --y 1765 --z 5049 --w 768 --h 1536 --d 768 --chunk 768
# python boundaries_to_nrrd.py --x 3380 --y 1765 --z 4281 --w 768 --h 1536 --d 768 --chunk 768
# python boundaries_to_nrrd.py --x 3400 --y 1900 --z 3513 --w 768 --h 768 --d 768 --chunk 768
# python boundaries_to_nrrd.py --x 3413 --y 1831 --z 2736 --w 768 --h 768 --d 768 --chunk 768
# python boundaries_to_nrrd.py --x 3424 --y 1860 --z 1968 --w 768 --h 768 --d 768 --chunk 768

# python boundaries_to_nrrd.py --x 3490 --y 1537 --z 1200 --w 768 --h 1536 --d 768 --chunk 768
# python boundaries_to_nrrd.py --x 3574 --y 1693 --z 432 --w 768 --h 1536 --d 768 --chunk 768
# python boundaries_to_nrrd.py --x 3674 --y 1722 --z 0 --w 768 --h 1536 --d 768 --chunk 768

nz, ny, nx, zarr_chunk = 100, 100, 100, 128

zarr_folder = "/Users/yao/Desktop/full-scrolls/boundaries.zarr/"
url_template = 'https://dl.ash2txt.org/other/dev/meshes/boundaries.zarr/'
    ...
    for z in range(zs, ze, nrrd_chunk):
        ...
        for y in range(ys, ye, nrrd_chunk):
            for x in range(xs, xe, nrrd_chunk):
                print(f"Processing {z:05d}_{y:05d}_{x:05d}_boundaries.nrrd ...")
                ...
                filename = os.path.join(output_folder, f'{z:05d}_{y:05d}_{x:05d}_boundaries.tif')
                tifffile.imwrite(filename, cube)
                filename = os.path.join(output_folder, f'{z:05d}_{y:05d}_{x:05d}_boundaries.nrrd')
